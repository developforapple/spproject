...
- (void)initProgressView
{
    ...
    NSDictionary *views = @{@"view":self.progressView};
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-0-[view(==4)]" options:kNilOptions metrics:nil views:views]];
